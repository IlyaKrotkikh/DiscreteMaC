...
{
    public class DirectedGraphWithPointID : AbstractGraph<PointWithID, EdgePointID>, IGraphBasics<PointWithID,EdgePointID>
    {
        protected int PointIncrementalCounter { get; set; }

        public string PointNamePrefix { get; set; }

        public DirectedGraphWithPointID(string GraphName, string PointNamePrefix,IEqualityComparer<EdgePointID> EdgeComparer) : base(GraphName, EdgeComparer)
        {
