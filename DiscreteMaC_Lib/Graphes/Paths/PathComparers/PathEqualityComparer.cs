...
{
    public class PathEqualityComparer<EdgeType, PointType> : IEqualityComparer<AbstractPath<EdgeType, PointType>> where EdgeType: IEdgeBasics<Point> where PointType : Point
    {
